...
clickAvatar.addEventListener('click', () => {
    ...
    // Change the background color and image temporarily
    const originalAvatar = clickAvatar.src;
    clickAvatar.src = 'images/avatar2.png';
    body.style.backgroundColor = 'white';
    setTimeout(() => {
        body.style.backgroundColor = 'black';
        clickAvatar.src = originalAvatar;
    }, 2000); // 2 seconds
});
...
flashMessage.textContent = 'тут моргает цвет';
